<template>
	<div>
		...
		<input type="hidden" name="membership_type" :value="this.membership_type">
	...
	export default{
		...
		methods:
		{
            ...
            submitForm()
            {
        		...
        		axios.post('/admin/subadmin/add/validationUser',formData,{headers: {'Content-Type': 'multipart/form-data'}}).then(response => {     
         			$('#submit-btn').click(); 
        		}).catch(error => {
