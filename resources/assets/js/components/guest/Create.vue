    ...
    export default {
        ...
        methods:
        {
            ...
            submitForm()
            {
                ...
                axios.post('/admin/guest/add/validationUser',formData,{headers: {'Content-Type': 'multipart/form-data'}}).then(response => {     
                    $('#submit-btn').click(); 
                }).catch(error => {
            ...
            getData()
            {
                axios.get('/admin/guest').then(response => {
